...
estrutural (header, auth, painel, Info, Rankings e loader) segue o acento
do tema ativo; guias de instalação em passos (latest, HTTPS, admin, FTP e
atualização).
Publicado: **[2.5.3]** —
...
e instalação pela Release que grava `REDIS_PASSWORD` antes do Compose.
