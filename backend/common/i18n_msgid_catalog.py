...
_("O servidor está em período de lançamento. O cadastro de novas contas está fechado no momento.")
...
_("O servidor está em período de lançamento. A criação de contas do jogo está fechada no momento.")
...
_("Limite de tentativas de 2FA excedido. Entre novamente.")
