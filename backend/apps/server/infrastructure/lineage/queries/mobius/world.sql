-- Mobius — mundo: olimpíada, bosses, siege, busca, clans.

-- name: olympiad_ranking
SELECT
    C.char_name AS name,
    O.olympiad_points AS value,
    C.online,
    D.name AS clan_name,
...
ORDER BY O.olympiad_points DESC, CS.class_id ASC, C.char_name ASC
...
LEFT JOIN characters P ON P.obj_Id = S.leader_id
