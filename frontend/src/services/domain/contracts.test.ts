...
const contracts: Contract[] = [
  ...
  ['content.assistantReplyScreen', () => contentApi.assistantReply('Where is my account?', 'en', undefined, undefined, '/painel/wallet'), '/shared/content/assistant/reply/', 'POST', { message: 'Where is my account?', language: 'en', screen: '/painel/wallet' }],
