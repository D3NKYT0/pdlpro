...
const contracts: Contract[] = [
  ...
  ['games.fight', () => gamesApi.fight('monster'), '/customer/games/economy/monster/fight/', 'POST', { strikes: 0 }],
  ['games.fightStrikes', () => gamesApi.fight('boss', { strikes: 4 }), '/customer/games/economy/boss/fight/', 'POST', { strikes: 4 }],
