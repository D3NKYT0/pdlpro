...
export const LEGACY_EXACT_REDIRECTS: Array<{ from: string; to: string }> = [
  ...
  { from: '/painel/admin/coming-soon', to: '/panel/admin/coming-soon' },
  ...
  { from: '/painel/admin/calendario', to: '/panel/admin/calendar' },
  { from: '/painel/admin/faq', to: '/panel/admin/faq' },
  { from: '/painel/admin/wiki', to: '/panel/admin/wiki' },
  { from: '/painel/admin/downloads', to: '/panel/admin/downloads' },
  { from: '/painel/admin/notificacoes', to: '/panel/admin/notifications' },
