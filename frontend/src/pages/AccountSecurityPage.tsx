...
export function AccountSecurityPage() {
  ...
  async function requestVerification() {
    ...
    try {
      ...
      toast.error(apiErrorMessage(error, 'Não foi possível enviar o e-mail.'))
    } finally { setBusy('') }
  }
  ...
  async function setup2fa() {
    ...
    try {
      ...
      toast.error(apiErrorMessage(error, 'Não foi possível iniciar o 2FA.'))
    } finally { setBusy('') }
  }
  ...
  async function addPasskey() {
    ...
    try {
      ...
      toast.error(apiErrorMessage(error, 'Não foi possível adicionar a chave.'))
    } finally { setBusy('') }
  }
  ...
  async function removePasskey(id: string) {
    try {
      ...
      toast.error(apiErrorMessage(error, 'Não foi possível remover a chave.'))
    }
  }
