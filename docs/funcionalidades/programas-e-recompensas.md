...
Os **Baús Encantados** funcionam diferente da roleta: o **item em mira é sempre lendário** e já está em um dos pacotes. Quem compra leva o item se abrir todos — a sorte só decide se sai no primeiro ou no último. A compra do baú é em reais e libera de **20 a 50 pacotes** (comum → lendário); **abrir** um pacote consome 1 ficha. Os outros pacotes saem só do catálogo do tier (sem outro lendário). O baú do card treme e, em seguida, um modal no centro troca os frames (fechado → entreaberto → aberto) e revela o item, sem toast. O autoconfig coloca Ring of Baium como mira em todos os baús; o resto do catálogo segue o tier (comum/raro, raro/épico, épico). A arte do baú é pixel art da paleta do painel (`images/games/box-*.webp`), não foto.
