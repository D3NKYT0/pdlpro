...
Os **Baús Encantados** vendem uma caçada: cada baú mostra o **item em mira** (arma S, joia de boss, encantamento) e o que mais pode sair nas outras aberturas. A compra é em reais; **abrir** um slot consome 1 ficha. O baú do card treme e, em seguida, um modal no centro troca os frames do baú (fechado → entreaberto → aberto) e revela o item, sem toast. Os baús default do autoconfig separam o catálogo por raridade (comum sem joia de boss; lendário com Ring of Baium e Blessed Enchant S). A arte do baú é pixel art da paleta do painel (`images/games/box-*.webp`), não foto.
