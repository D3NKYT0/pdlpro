...
Os cosméticos são camadas vetoriais/CSS nas poses estáticas, incluindo conversa. O broche de estrela é um SVG esmaltado no bolso esquerdo do sprite (à direita na tela), com âncora por pose em pé; some nas poses deitada e de atividade para não flutuar fora da roupa. Os atlas de comer, brincar, rir, dormir, dançar, carinho, banho, caminhar, pensar, confuso e comemorar nível preservam sua arte original. Dança, banho, caminhada, espera viva, pequenos gestos durante a fala e a comemoração respeitam **Animar personagem** e movimento reduzido. Falas de cuidado variam, e o prompt pede ao modelo para evitar repetir aberturas e bordões do histórico.
...
| 45 segundos sem interação | Vida ambient contínua: fala com boca animada, lanches, jogos, dança, banho, caminhadas, risadas, pensamentos e, às vezes, sono — depois acorda e segue |
...
Depois de 45 segundos sem conversa, cuidado ou rascunho, o Denkynho inicia uma vida ambient local ([idleRoutine.ts](../../frontend/src/components/help/idleRoutine.ts)): monta um plano com vários episódios (conversar, lanche, jogar, dançar se desbloqueado, banho, caminhar pelos cômodos, rir, pensar, espreguiçar e, às vezes, dormir). Em cada episódio ele **fala** de verdade — frase no status do companion (fora do histórico do chat) e boca sincronizada com `speechFrame` — e depois age com a pose/atlas correspondente. Cenas temporárias usam `sceneOverride` e não chamam `PATCH` do armário. Depois de dormir, ele acorda e continua vivendo. Com movimento reduzido, pula caminhadas longas. Digitar, enviar ou iniciar um cuidado cancela tudo e restaura a cena equipada. Cada atividade solicitada manualmente permanece por oito segundos e todos os timers são liberados ao desmontar a tela.
