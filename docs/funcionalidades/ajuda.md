...
Depois de 45 segundos sem conversa nem cuidado, ele dorme em uma cama com travesseiro e coberta azul. Digitar, enviar ou iniciar um cuidado interrompe o descanso; respostas em andamento, falhas e moderação têm prioridade. Cada atividade solicitada permanece por oito segundos e todos os timers são liberados ao desmontar a tela.

Com **Animar personagem** desligado ou movimento reduzido no dispositivo, não há reprodução de quadros nem movimentos CSS. Ainda é possível cuidar manualmente do mascote e os atributos continuam sendo atualizados. A fala continua apenas visual, sem áudio. Os botões são os componentes compartilhados do tema, com quebra de linha no celular.
