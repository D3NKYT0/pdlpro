...
painel HTML encaixa com precisão (coordenadas `--frame-*`), anel luminoso, kicker “Servidor
aberto”, mensagem “O momento chegou” e ênfase no botão Entrar. O Coming Soon continua ativo
até a equipe desligar o modo no painel.
