...
- Páginas finas: orquestração em hooks de feature quando o estado cresce (ex.: `useHelpPageController`).
...
funcionar integralmente quando nenhum pacote está ativo. Pacote de cliente não entra
em `src/`. Veja o [contrato de temas](../funcionalidades/temas.md).
