...
[Denkynho](../../frontend/src/components/help/Denkynho.tsx) compõe as camadas PNG do mascote com pose, fala, piscadas e movimento reduzido. Comer, jogar e rir usam `ActivitySprite`, com sequências de quadros pré-carregadas, recortes e ancoragem pelos pés. `useMascotPose` centraliza as transições, a fila de atividades e o espelhamento por visita, preservando a prioridade da conversa. A camada de orientação envolve corpo e recortes faciais juntos e não sobrescreve a transformação da animação. A página de Ajuda controla os estados; consulte [Ajuda e Denkynho](../funcionalidades/ajuda.md) para o contrato e os cenários de teste.
