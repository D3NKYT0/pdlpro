...
| Temas e shells globais | [ThemeProvider.test.tsx](../../frontend/src/theme/ThemeProvider.test.tsx), [accent-chrome.test.ts](../../frontend/src/theme/accent-chrome.test.ts), [PortalTheme.test.tsx](../../frontend/src/components/themes/PortalTheme.test.tsx), [AuthPanel.test.tsx](../../frontend/src/components/auth/AuthPanel.test.tsx), [PrivateLayout.test.tsx](../../frontend/src/components/layout/PrivateLayout.test.tsx). A suíte cobre o chrome estrutural e o Classic; pacote de cliente não entra em `src/`. |
