...
| Temas e shells globais | [ThemeProvider.test.tsx](../../frontend/src/theme/ThemeProvider.test.tsx), [accent-chrome.test.ts](../../frontend/src/theme/accent-chrome.test.ts), [PortalTheme.test.tsx](../../frontend/src/components/themes/PortalTheme.test.tsx), [AuthPanel.test.tsx](../../frontend/src/components/auth/AuthPanel.test.tsx), [PrivateLayout.test.tsx](../../frontend/src/components/layout/PrivateLayout.test.tsx). O contrato textual do Cruma usado no CI fica em [fixtures/cruma](../../frontend/src/theme/fixtures/cruma). |
