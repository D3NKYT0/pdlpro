...
| Temas e shells globais | [ThemeProvider.test.tsx](../../frontend/src/theme/ThemeProvider.test.tsx), [accent-chrome.test.ts](../../frontend/src/theme/accent-chrome.test.ts), [catalog.test.ts](../../frontend/src/theme/templates/catalog.test.ts), [CatalogHome.test.tsx](../../frontend/src/theme/templates/CatalogHome.test.tsx), [PortalTheme.test.tsx](../../frontend/src/components/themes/PortalTheme.test.tsx), [AuthPanel.test.tsx](../../frontend/src/components/auth/AuthPanel.test.tsx), [PrivateLayout.test.tsx](../../frontend/src/components/layout/PrivateLayout.test.tsx). A suíte cobre o chrome estrutural, o Classic e o catálogo de 20 templates; pacote de cliente não entra em `src/`. |
| Extensões de cliente | [extensions/tests](../../backend/extensions/tests/), [test_hooks.py](../../backend/common/tests/test_hooks.py), [frontend/src/extensions/*.test.*](../../frontend/src/extensions/) |
